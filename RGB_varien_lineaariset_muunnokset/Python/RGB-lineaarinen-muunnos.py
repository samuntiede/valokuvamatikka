...
kuva = plt.imread("../_kuvat/saunan_korjaus.png")  
...
"""
Vaihtoehtoinen (hitaampi) tapa matriisien kertolaskulla
...
for i in range(leveys):
    ...
    for j in range(korkeus):
        ...
        uusi_vari = A @ np.transpose(vari)  # Matriisikertolasku @-merkilla
        
        #uusi_vari = uusi_vari**2 mahdollisuus lisämuokkaukseen
        
        uusi_kuva[j,i,:] = np.transpose(uusi_vari)
...
plt.imsave("../_kuvat/muokattu-kuva.png", uusi_kuva)
