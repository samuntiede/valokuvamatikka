...
% Read in the image
im_orig = imread('.._kuvat/Finni1.jpg','jpg'); % YOU CAN MODIFY HERE
...
imwrite(uint8(double(im_orig)),'../_kuvat/Finni_on.png','png')
imwrite(uint8(im2),'../_kuvat/Finni_pois.png','png')
